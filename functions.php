...
function addBAPHK($data)
{
  ...
  $query = "INSERT INTO tb_baphk VALUES(null, '$idUser', '$tglSurat',  '$noKegiatan', '$hariTerbilang', '$tglTerbilang', '$blnTerbilang', '$thnTerbilang', '$namaSatker', '$namaPerusahaan', '$alamatPerusahaan', '$noIzinUsaha', '$perubahanKe', '$nomorNpwp', '$namaPekerjaan', '$tahunAnggaran', '$namaPp', '$namaWakilPenyedia', '$tglBuat') ";
...
function addBAHP($data)
{
  ...
  $query = "INSERT INTO tb_bahp VALUES(null, '$idUser', '$tglSurat','$noKegiatan', '$hariTerbilang', '$tglTerbilang', '$blnTerbilang', '$thnTerbilang', '$namaSatker', '$namaPerusahaan', '$alamatPerusahaan', '$nomorNpwp',  '$namaPekerjaan', '$tahunAnggaran', '$kodeRup', '$hargaPenawaran', '$hargaNegosiasi', '$nomorDipa', '$namaPp', '$nip', '$tglBuat') ";
...
function addBAHPP($data)
{
  ...
  $query = "INSERT INTO tb_bahpp VALUES(null, '$idUser', '$tglSurat','$noKegiatan', '$hariTerbilang', '$tglTerbilang', '$blnTerbilang', '$thnTerbilang', '$namaSatker', '$alamatSatker', '$namaPerusahaan', '$alamatPerusahaan',   '$namaPekerjaan', '$tahunAnggaran', '$namaWakilPenyedia', '$jabatan', '$namaPpk', '$namaPerwakilanSm', '$namaPetugasVerifikasiMdp', '$namaPendukung1', '$namaPendukung2', '$jenisSurat', '$noJenisSurat', '$uraian', '$tglBuat') ";
